# BerryCode Wiki — The IDE Built for Bevy
...
**BerryCode is the first IDE purpose-built for the Bevy game engine.** Not a general-purpose editor with plugins — an IDE that understands Bevy's ECS, scene format, and workflow natively. Built with Bevy + bevy_egui + WGPU — the same stack as your game.
...
- [Keyboard Shortcuts](Keyboard-Shortcuts) — All shortcuts + Vim commands
...
**BerryCode は Bevy ゲームエンジン専用に作られた、初めての IDE です。** 汎用エディタにプラグインを後付けしたものではなく、Bevy の ECS、シーンフォーマット、ワークフローをネイティブに理解します。Bevy + bevy_egui + WGPU で構築 — あなたのゲームと同じスタック。
...
- [キーボードショートカット](Keyboard-Shortcuts) — 全ショートカット + Vim コマンド
